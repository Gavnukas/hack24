...
app.config.update({
    'SQLALCHEMY_DATABASE_URI': os.environ.get('DATABASE_URL', 'postgres://sjdakwdfcqiszc:pwAQ9QFehrrKC_EPj9LH_zh73S@ec2-54-217-238-100.eu-west-1.compute.amazonaws.com:5432/d3omvfc3v4n1hs'),
})
db = SQLAlchemy(app)
